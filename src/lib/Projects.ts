const projects = [
	{
		...
		description:
			'Dao is a data and music visualization of popular books/films and old philosophical Chinese texts. It uses a python sentiment analysis algorithm to analyze the emotions present in a text and live draw pictures/create music based on the emotions in each section of the text',
